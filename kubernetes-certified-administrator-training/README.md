...
### Prérequis : [Docker](https://eazytraining.fr/cours/introduction-a-docker/) et [Kubernetes](https://eazytraining.fr/cours/kubernetes-les-bases-pour-devops/)
...
## Déployer vos premières applications sur k8s

## Gestion du reseau
https://metallb.universe.tf/

https://landscape.cncf.io/card-mode?selected=metal-lb
...
## Gestion du cluster
https://faun.pub/kubernetes-deployment-which-tool-7e6eaca99dfa
...
https://drive.google.com/drive/folders/1vH3OVlYTFec0GDtZE33yNOr9C66LsRdG?usp=share_link
